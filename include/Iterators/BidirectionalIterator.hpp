...
// Version : 2.0.0
// This is a header file for 'QMXStdLib'; it defines the interface for a bidirectional iterator class.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/**
  ...
  * @version 2.0.0
  *
  * @brief This header file defines the interface for a bidirectional iterator class.
  *
  * @section BidirectionalIteratorH0000 Description
  *
  * This header file defines the interface for a bidirectional iterator class.
  *
  * @section BidirectionalIteratorH0001 License
  *
  * Copyright (C) 2011-2019 QuantuMatriX Software, a QuantuMatriX Technologies Cooperative Partnership
  *
  * This file is part of 'QMXStdLib'.
...
#ifndef __QMX_QMXSTDLIB_BIDIRECTIONALITERATOR_HPP_
#define __QMX_QMXSTDLIB_BIDIRECTIONALITERATOR_HPP_
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The 'BidirectionalIterator' Class
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/**
  * @class BidirectionalIterator BidirectionalIterator.hpp "include/Iterators/BidirectionalIterator.hpp"
  *
  * @brief This class defines the interface for an bidirectional iterator.
  *
  * These algorithms are useful when it is necessary to create STL-style iterators with bidirectional capabilities.  The iterator element must support the
  * following operators:
  *
  * - Pre-Increment<br>
  * - Post-Increment<br>
...
public:
	...
	// Public Constructors
		...
		BidirectionalIterator( EType* target )
		{
			// Initialize fields.
		...
		BidirectionalIterator( const BidirectionalIterator& instance )
		{
			// Initialize fields.
	...
	// Public Overloaded Operators
		...
		BidirectionalIterator& operator=( EType* target )
		{
		...
		BidirectionalIterator& operator=( const BidirectionalIterator& instance )
		{
		...
		BidirectionalIterator operator++( int )
		{
			// Create local variables.
				...
				BidirectionalIterator result( elementCurrent );
...
#endif // __QMX_QMXSTDLIB_BIDIRECTIONALITERATOR_HPP_

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// End of 'BidirectionalIterator.hpp'
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
